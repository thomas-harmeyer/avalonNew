...
var Game = (function () {
    ...
    Game.findByOpe = function (ope) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.findOne({ ope: ope }).exec()];
            });
        });
    };
    ...
    __decorate([
        typegoose_1.prop({ type: function () { return [User_1.User]; }, required: true })
    ...
    __decorate([
        typegoose_1.prop({ type: function () { return [[Mission_1.Mission]]; } })
    ], Game.prototype, "missions");
    Game = Game_1 = __decorate([
        typegoose_1.pre("save", function () {
            this.missions = [];
            var missionCount = Mission_1.missionCounts[this.users.length];
...
function containsUser(game, userContains) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2, (game.users.filter(function (userToFilter, i) {
